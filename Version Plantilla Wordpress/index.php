      ...
      <section class="banner-principal">
        ...
        <div class="texto-banner">
          ...
          <?php if ( is_category() ): ?>
            ...
            <h3><?php _e('Categoría:', 'slan'); ?> <?php single_cat_title(); ?></h3>
          ...
          <?php elseif( is_search() ): ?>
            ...
            <h3><?php _e('Resultados de búsqueda para:', 'slan'); ?> <?php the_search_query(); ?></h3>
          ...
          <?php elseif( is_404() ): ?>
            ...
            <h3><?php _e('No se encontró la página', 'slan'); ?></h3>
